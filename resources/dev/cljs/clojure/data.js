...
{return cljs.core.reduce.call(null,(function (result,p__34745){var vec__34746 = p__34745;var k = cljs.core.nth.call(null,vec__34746,(0),null);var v = cljs.core.nth.call(null,vec__34746,(1),null);return cljs.core.assoc.call(null,result,k,v);
...
*/
clojure.data.diff_associative_key = (function diff_associative_key(a,b,k){var va = cljs.core.get.call(null,a,k);var vb = cljs.core.get.call(null,b,k);var vec__34748 = clojure.data.diff.call(null,va,vb);var a_STAR_ = cljs.core.nth.call(null,vec__34748,(0),null);var b_STAR_ = cljs.core.nth.call(null,vec__34748,(1),null);var ab = cljs.core.nth.call(null,vec__34748,(2),null);var in_a = cljs.core.contains_QMARK_.call(null,a,k);var in_b = cljs.core.contains_QMARK_.call(null,b,k);var same = (in_a) && (in_b) && ((!((ab == null))) || (((va == null)) && ((vb == null))));return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((in_a) && ((!((a_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,a_STAR_], true, false):null),(((in_b) && ((!((b_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,b_STAR_], true, false):null),((same)?new cljs.core.PersistentArrayMap.fromArray([k,ab], true, false):null)], null);
});
/**
...
clojure.data.EqualityPartition = (function (){var obj34750 = {};return obj34750;
})();
clojure.data.equality_partition = (function equality_partition(x){if((function (){var and__3567__auto__ = x;if(and__3567__auto__)
...
{var x__4206__auto__ = (((x == null))?null:x);return (function (){var or__3579__auto__ = (clojure.data.equality_partition[goog.typeOf(x__4206__auto__)]);if(or__3579__auto__)
{return or__3579__auto__;
} else
{var or__3579__auto____$1 = (clojure.data.equality_partition["_"]);if(or__3579__auto____$1)
...
clojure.data.Diff = (function (){var obj34752 = {};return obj34752;
})();
clojure.data.diff_similar = (function diff_similar(a,b){if((function (){var and__3567__auto__ = a;if(and__3567__auto__)
...
{var x__4206__auto__ = (((a == null))?null:a);return (function (){var or__3579__auto__ = (clojure.data.diff_similar[goog.typeOf(x__4206__auto__)]);if(or__3579__auto__)
{return or__3579__auto__;
} else
{var or__3579__auto____$1 = (clojure.data.diff_similar["_"]);if(or__3579__auto____$1)
{return or__3579__auto____$1;
} else
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__34753 = x;if(G__34753)
{var bit__4229__auto__ = (G__34753.cljs$lang$protocol_mask$partition0$ & (1024));if((bit__4229__auto__) || (G__34753.cljs$core$IMap$))
{return true;
} else
{if((!G__34753.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__34753);
} else
{return false;
}
}
...
{if((function (){var G__34754 = x;if(G__34754)
{var bit__4229__auto__ = (G__34754.cljs$lang$protocol_mask$partition0$ & (4096));if((bit__4229__auto__) || (G__34754.cljs$core$ISet$))
{return true;
} else
{if((!G__34754.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__34754);
} else
{return false;
}
}
...
{if((function (){var G__34755 = x;if(G__34755)
{var bit__4229__auto__ = (G__34755.cljs$lang$protocol_mask$partition0$ & (16777216));if((bit__4229__auto__) || (G__34755.cljs$core$ISequential$))
{return true;
} else
{if((!G__34755.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__34755);
} else
{return false;
}
}
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__34756 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);switch (G__34756) {
case "map":
