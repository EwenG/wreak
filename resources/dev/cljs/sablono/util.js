...
sablono.util.ToString = (function (){var obj34505 = {};return obj34505;
})();
sablono.util.to_str = (function to_str(x){if((function (){var and__3567__auto__ = x;if(and__3567__auto__)
...
{var x__4206__auto__ = (((x == null))?null:x);return (function (){var or__3579__auto__ = (sablono.util.to_str[goog.typeOf(x__4206__auto__)]);if(or__3579__auto__)
{return or__3579__auto__;
} else
{var or__3579__auto____$1 = (sablono.util.to_str["_"]);if(or__3579__auto____$1)
...
sablono.util.ToURI = (function (){var obj34507 = {};return obj34507;
})();
sablono.util.to_uri = (function to_uri(x){if((function (){var and__3567__auto__ = x;if(and__3567__auto__)
...
{var x__4206__auto__ = (((x == null))?null:x);return (function (){var or__3579__auto__ = (sablono.util.to_uri[goog.typeOf(x__4206__auto__)]);if(or__3579__auto__)
{return or__3579__auto__;
} else
{var or__3579__auto____$1 = (sablono.util.to_uri["_"]);if(or__3579__auto____$1)
{return or__3579__auto____$1;
} else
...
as_str.cljs$lang$applyTo = (function (arglist__34508){
var xs = cljs.core.seq(arglist__34508);
...
{var vec__34510 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__34510,(0),null);var words = cljs.core.nthnext.call(null,vec__34510,(1));if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__34511_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__34511_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__34511_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__34511_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__34512){
var maps = cljs.core.seq(arglist__34512);
...
*/
sablono.util.normalize_element = (function normalize_element(p__34513){var vec__34516 = p__34513;var tag = cljs.core.nth.call(null,vec__34516,(0),null);var content = cljs.core.nthnext.call(null,vec__34516,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__34517 = cljs.core.re_matches.call(null,sablono.util.re_tag,cljs.core.name.call(null,tag));var _ = cljs.core.nth.call(null,vec__34517,(0),null);var tag__$1 = cljs.core.nth.call(null,vec__34517,(1),null);var id = cljs.core.nth.call(null,vec__34517,(2),null);var class$ = cljs.core.nth.call(null,vec__34517,(3),null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_(class$)?clojure.string.split.call(null,class$,/\./):null)], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
goog.Uri.prototype.sablono$util$ToString$to_str$arity$1 = (function (x){var x__$1 = this;if(cljs.core.truth_((function (){var or__3579__auto__ = x__$1.hasDomain();if(cljs.core.truth_(or__3579__auto__))
{return or__3579__auto__;
} else
