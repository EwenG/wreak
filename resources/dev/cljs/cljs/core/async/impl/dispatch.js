...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_34379 = (0);while(true){
var m_34380 = cljs.core.async.impl.dispatch.tasks.pop();if((m_34380 == null))
{} else
{m_34380.call(null);
if((count_34379 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__34381 = (count_34379 + (1));
count_34379 = G__34381;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3567__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3567__auto__)
