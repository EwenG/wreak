...
datascript.btset.level_shift = (cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__29319_SHARP_){return ((datascript.btset.max_len & (1 << p1__29319_SHARP_)) != 0);
...
datascript.btset.cut_n_splice = (function cut_n_splice(arr,cut_from,cut_to,splice_from,splice_to,xs){var arr_l = arr.length;var xs_l = xs.length;var l1 = (splice_from - cut_from);var l2 = (cut_to - splice_to);var l1xs = (l1 + xs_l);var new_arr = (new Array(((l1 + xs_l) + l2)));var n__4435__auto___29336 = l1;var i_29337 = (0);while(true){
if((i_29337 < n__4435__auto___29336))
{(new_arr[i_29337] = (arr[(cut_from + i_29337)]));
{
var G__29338 = (i_29337 + (1));
i_29337 = G__29338;
continue;
}
} else
...
var n__4435__auto___29339 = xs_l;var i_29340 = (0);while(true){
if((i_29340 < n__4435__auto___29339))
{(new_arr[(i_29340 + l1)] = (xs[i_29340]));
{
...
var n__4435__auto___29342 = l2;var i_29343 = (0);while(true){
if((i_29343 < n__4435__auto___29342))
{(new_arr[(i_29343 + l1xs)] = (arr[(splice_to + i_29343)]));
{
...
datascript.btset.merge_n_split = (function merge_n_split(a1,a2){var a1_l = a1.length;var a2_l = a2.length;var total_l = (a1_l + a2_l);var r1_l = datascript.btset.half.call(null,total_l);var r2_l = (total_l - r1_l);var r1 = (new Array(r1_l));var r2 = (new Array(r2_l));var n__4435__auto___29345 = total_l;var i_29346 = (0);while(true){
if((i_29346 < n__4435__auto___29345))
{((((i_29346 < r1_l))?r1:r2)[(((i_29346 < r1_l))?i_29346:(i_29346 - r1_l))] = ((((i_29346 < a1_l))?a1:a2)[(((i_29346 < a1_l))?i_29346:(i_29346 - a1_l))]));
{
var G__29347 = (i_29346 + (1));
i_29346 = G__29347;
continue;
}
} else
...
datascript.btset.eq_arr = (function eq_arr(a1,a1_from,a1_to,a2,a2_from,a2_to,cmp){var len = (a1_to - a1_from);var and__3567__auto__ = (len === (a2_to - a2_from));if(and__3567__auto__)
{var i = (0);while(true){
if((i === len))
{return true;
} else
...
{if(cljs.core.truth_((function (){var and__3567__auto__ = left;if(cljs.core.truth_(and__3567__auto__))
...
{if(cljs.core.truth_((function (){var and__3567__auto__ = right;if(cljs.core.truth_(and__3567__auto__))
...
datascript.btset.Node.cljs$lang$ctorPrWriter = (function (this__4146__auto__,writer__4147__auto__,opt__4148__auto__){return cljs.core._write.call(null,writer__4147__auto__,"datascript.btset/Node");
});
...
datascript.btset.LeafNode.cljs$lang$ctorPrWriter = (function (this__4146__auto__,writer__4147__auto__,opt__4148__auto__){return cljs.core._write.call(null,writer__4147__auto__,"datascript.btset/LeafNode");
});
...
if((level > (0)))
{{
var G__29349 = (level - datascript.btset.level_shift);
var G__29350 = (node.pointers[datascript.btset.path_get.call(null,path,level)]);
level = G__29349;
node = G__29350;
continue;
}
...
datascript.btset.btset_conj = (function btset_conj(set,key){var _STAR_cmp_STAR_29352 = datascript.btset._STAR_cmp_STAR_;try{datascript.btset._STAR_cmp_STAR_ = set.comparator;
...
}finally {datascript.btset._STAR_cmp_STAR_ = _STAR_cmp_STAR_29352;
}});
datascript.btset.btset_disj = (function btset_disj(set,key){var _STAR_cmp_STAR_29354 = datascript.btset._STAR_cmp_STAR_;try{datascript.btset._STAR_cmp_STAR_ = set.comparator;
...
}finally {datascript.btset._STAR_cmp_STAR_ = _STAR_cmp_STAR_29354;
}});
...
datascript.btset.BTSetIter.cljs$lang$ctorPrWriter = (function (this__4146__auto__,writer__4147__auto__,opt__4148__auto__){return cljs.core._write.call(null,writer__4147__auto__,"datascript.btset/BTSetIter");
});
...
var G__29355 = (node.pointers[idx]);
var G__29356 = datascript.btset.path_set.call(null,path,level,idx);
var G__29357 = (level - datascript.btset.level_shift);
node = G__29355;
path = G__29356;
level = G__29357;
continue;
...
var G__29358 = (node.pointers[idx]);
var G__29359 = datascript.btset.path_set.call(null,path,level,idx);
var G__29360 = (level - datascript.btset.level_shift);
node = G__29358;
path = G__29359;
level = G__29360;
continue;
...
var slice__3 = (function (set,key_from,key_to){var _STAR_cmp_STAR_29362 = datascript.btset._STAR_cmp_STAR_;try{datascript.btset._STAR_cmp_STAR_ = set.comparator;
return datascript.btset._slice.call(null,set,key_from,key_to);
}finally {datascript.btset._STAR_cmp_STAR_ = _STAR_cmp_STAR_29362;
}});
...
datascript.btset.BTSet.cljs$lang$ctorPrWriter = (function (this__4146__auto__,writer__4147__auto__,opt__4148__auto__){return cljs.core._write.call(null,writer__4147__auto__,"datascript.btset/BTSet");
});
...
var ___$1 = this;var _STAR_cmp_STAR_29365 = datascript.btset._STAR_cmp_STAR_;try{datascript.btset._STAR_cmp_STAR_ = self__.comparator;
var or__3579__auto__ = self__.root.lookup(k);if(cljs.core.truth_(or__3579__auto__))
{return or__3579__auto__;
} else
{return not_found;
}
}finally {datascript.btset._STAR_cmp_STAR_ = _STAR_cmp_STAR_29365;
}});
...
{var h__3990__auto____$1 = cljs.core.hash_iset.call(null,coll__$1);self__.__hash = h__3990__auto____$1;
...
return (function (p1__29363_SHARP_){return cljs.core.contains_QMARK_.call(null,this$__$1,p1__29363_SHARP_);
});})(this$__$1))
,other));
});
...
;
datascript.btset.BTSet.prototype.apply = (function (self__,args29364){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args29364)));
});
...
var G__29367__delegate = function (cmp,keys){return cljs.core.reduce.call(null,cljs.core._conj,btset_by.call(null,cmp),keys);
};
var G__29367 = function (cmp,var_args){
var keys = null;if (arguments.length > 1) {
  keys = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__29367__delegate.call(this,cmp,keys);};
G__29367.cljs$lang$maxFixedArity = 1;
G__29367.cljs$lang$applyTo = (function (arglist__29368){
var cmp = cljs.core.first(arglist__29368);
var keys = cljs.core.rest(arglist__29368);
return G__29367__delegate(cmp,keys);
});
...
var G__29369__delegate = function (keys){return cljs.core.reduce.call(null,cljs.core._conj,btset.call(null),keys);
};
var G__29369 = function (var_args){
var keys = null;if (arguments.length > 0) {
  keys = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__29369__delegate.call(this,keys);};
G__29369.cljs$lang$maxFixedArity = 0;
G__29369.cljs$lang$applyTo = (function (arglist__29370){
var keys = cljs.core.seq(arglist__29370);
return G__29369__delegate(keys);
});
